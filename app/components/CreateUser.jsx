...
export default (props) => {
  ...
  return (
      <form className="form-group " onSubmit={props.handleSubmit}>
        <div className='parent-box form-group col-md-offset-3 col-md-6 col-sm-6 col-sm-offset-3 col-xs-12'>
          <div className="form-group col-md-offset-3 col-md-6 col-sm-6 col-sm-offset-3 col-xs-12 first-form-input">
            <label htmlFor="usr">Name:</label>
            <input name="userName" type="text" className="form-control" id="usr" placeholder="Firstname Lastname (e.g. Blake Lively)" />
          </div>
          <div className="form-group col-md-offset-3 col-md-6 col-sm-6 col-sm-offset-3 col-xs-12">
          ...
          <br />
          <Link to='/login' className="col-md-2" >Already have an account?</Link>
        </div>
      </form>
  );
};
